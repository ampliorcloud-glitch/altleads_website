...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans" style={{ background: '#121212', color: '#F8F5F0' }}>
      
      {/* Background ambient glow */}
      <div className="fixed top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full blur-[150px] opacity-10 pointer-events-none" style={{ background: '#E07A5F' }} />
      <div className="fixed bottom-[-20%] right-[-10%] w-[40%] h-[40%] rounded-full blur-[150px] opacity-[0.05] pointer-events-none" style={{ background: '#4A90E2' }} />
      ...
      <nav className="fixed top-0 w-full z-50 px-8 py-4 backdrop-blur-md" style={{ background: 'rgba(18, 18, 18, 0.7)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium" style={{ color: '#A0A0A0' }}>
            <a href="#reality" className="hover:text-[#E07A5F] transition-colors">The Reality</a>
            <a href="#how-it-works" className="hover:text-[#E07A5F] transition-colors">How It Works</a>
            <a href="#modules" className="hover:text-[#E07A5F] transition-colors">Modules</a>
      ...
      <main className="relative z-10 flex flex-col items-center">
        ...
        <section className="relative pt-40 pb-20 px-8 w-full max-w-7xl flex flex-col items-center text-center min-h-[90vh] justify-center">
          <motion.div style={{ y, opacity }} className="absolute top-20 left-10 w-32 h-32 rounded-full blur-[100px]" style={{ background: '#E07A5F', opacity: 0.2 }} />
          ...
          >
            <motion.div variants={fadeUp} className="mb-8 inline-flex items-center gap-2 px-4 py-1.5 rounded-full backdrop-blur-sm" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)' }}>
              <span className="w-2 h-2 rounded-full" style={{ background: '#E07A5F' }} />
            ...
            >
              Accelerate your <br/>
              <span style={{ color: '#E07A5F' }}>pipeline.</span>
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center gap-4">
              <button
                onClick={() => navigate(session ? '/dashboard' : '/login')}
                className="group px-8 py-4 rounded-full text-base font-semibold transition-all hover:scale-105 flex items-center gap-2"
                style={{ 
                  background: '#E07A5F', 
                  color: '#121212',
              ...
              <div className="col-span-2 space-y-6">
                <div className="h-48 rounded-xl p-6 relative overflow-hidden group" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                   ...
                   <svg className="w-full h-20 absolute bottom-0 left-0 transition-transform duration-700 group-hover:scale-y-110 origin-bottom" viewBox="0 0 100 20" preserveAspectRatio="none">
                      <path d="M0,20 L20,15 L40,18 L60,5 L80,10 L100,0" fill="none" stroke="#E07A5F" strokeWidth="2" vectorEffect="non-scaling-stroke"/>
                   </svg>
                </div>
        ...
        <section id="reality" className="py-32 px-8 w-full max-w-7xl relative">
          <RevealSection className="text-center mb-20 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: 'var(--font-display)' }}>
              ...
              <span style={{ color: '#E07A5F' }}>They don't run outbound.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <RevealSection>
              <TiltCard className="p-8 rounded-2xl h-full" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <p className="text-sm mb-4" style={{ color: '#E07A5F' }}>Reps forget follow-ups</p>
            ...
            <RevealSection>
              <TiltCard className="p-8 rounded-2xl h-full" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <p className="text-sm mb-4" style={{ color: '#E07A5F' }}>Activity reporting is unreliable</p>
            ...
            <RevealSection>
              <TiltCard className="p-8 rounded-2xl h-full" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <p className="text-sm mb-4" style={{ color: '#E07A5F' }}>Generic AI suggestions</p>
          ...
          <RevealSection className="mt-16 text-center">
            <p className="text-lg max-w-3xl mx-auto" style={{ color: '#F8F5F0' }}>
              <strong style={{ color: '#E07A5F' }}>AltLeads fixes this by being workflow-first:</strong> It combines CRM, outreach cadences, and usable intelligence into one execution layer, so teams move faster and managers see what’s really happening.
            </p>
          </RevealSection>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              <RevealSection>
                <div className="relative z-10 flex flex-col">
                  <div className="w-14 h-14 rounded-full flex items-center justify-center font-bold text-xl mb-8" style={{ background: '#121212', border: '1px solid #E07A5F', color: '#E07A5F' }}>01</div>
              ...
              <RevealSection>
                <div className="relative z-10 flex flex-col">
                  <div className="w-14 h-14 rounded-full flex items-center justify-center font-bold text-xl mb-8" style={{ background: '#121212', border: '1px solid #E07A5F', color: '#E07A5F' }}>02</div>
              ...
              <RevealSection>
                <div className="relative z-10 flex flex-col">
                  <div className="w-14 h-14 rounded-full flex items-center justify-center font-bold text-xl mb-8" style={{ background: '#121212', border: '1px solid #E07A5F', color: '#E07A5F' }}>03</div>
        ...
        <section id="modules" className="py-32 px-8 w-full max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[240px]">
            ...
            <RevealSection className="md:col-span-2 md:row-span-2">
              <TiltCard className="h-full p-8 rounded-3xl flex flex-col relative overflow-hidden group" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#E07A5F] rounded-full blur-[100px] opacity-10 group-hover:opacity-20 transition-opacity duration-500" />
                <Workflow size={32} color="#E07A5F" className="mb-auto" />
                <div className="mt-8 relative z-10">
                  <h3 className="text-2xl font-bold mb-3">AltLeads CRM</h3>
                  <p style={{ color: '#A0A0A0', lineHeight: 1.6 }}>Workflow-first CRM designed for outbound and backend-to-sales alignment. Keep your source of truth active.</p>
                </div>
              </TiltCard>
            </RevealSection>
            ...
            <RevealSection className="md:col-span-2">
              <TiltCard className="h-full p-8 rounded-3xl flex flex-col justify-end relative overflow-hidden" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                <div className="flex gap-4 mb-4">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-black/30 text-[#A0A0A0]"><Mail size={18}/></div>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#0077b5]/20 text-[#0077b5]"><Briefcase size={18}/></div>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-[#25D366]/20 text-[#25D366]"><MessageSquare size={18}/></div>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-black/30 text-[#A0A0A0]"><Phone size={18}/></div>
                </div>
            ...
            <RevealSection>
              <TiltCard className="h-full p-8 rounded-3xl flex flex-col justify-end" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                <Database size={24} className="mb-4" color="#E07A5F" />
                <h3 className="text-lg font-bold mb-2">Data & Intelligence</h3>
                <p className="text-sm" style={{ color: '#A0A0A0' }}>Verified decision-maker data plus pitch guidance.</p>
              </TiltCard>
            </RevealSection>

            {/* Cell 4: WhatsApp (col-span-1, row-span-1) */}
            <RevealSection>
              <TiltCard className="h-full p-8 rounded-3xl flex flex-col justify-end" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                <LineChart size={24} className="mb-4" color="#E07A5F" />
                <h3 className="text-lg font-bold mb-2">Manager Visibility</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <RevealSection>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
                ...
                <span style={{ color: '#E07A5F' }}>built from real outbound.</span>
              </h2>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3">
                    <CheckCircle2 size={18} color="#E07A5F" className="flex-shrink-0" />
                    <span style={{ color: '#E07A5F' }}>{item}</span>
                  </li>
                ))}
              </ul>
              
              <div className="p-4 rounded-xl flex gap-4 items-start" style={{ background: 'rgba(224, 122, 95, 0.05)', border: '1px solid rgba(224, 122, 95, 0.2)' }}>
                <Shield size={20} color="#E07A5F" className="mt-1" />
                <div>
                  <h4 className="font-semibold mb-1" style={{ color: '#E07A5F' }}>Privacy Note</h4>
                  <p className="text-sm" style={{ color: '#A0A0A0' }}>Designed to be privacy-safe, using contextual research and aggregated patterns — not client-confidential exposure. Your data stays yours.</p>
                </div>
              </div>
            </RevealSection>
            
            <RevealSection>
              <div className="relative aspect-square rounded-3xl overflow-hidden p-8 flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                <div className="absolute inset-0 opacity-20 pointer-events-none" style={{ background: 'radial-gradient(circle at center, #E07A5F 0%, transparent 70%)' }} />
                
                {/* 3D-ish Floating UI Elements */}
                <motion.div 
                  animate={{ y: [0, -10, 0] }} 
                  transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
                  className="w-full max-w-sm rounded-xl p-6 backdrop-blur-md relative z-10 shadow-2xl"
                  style={{ background: 'rgba(30, 30, 30, 0.8)', border: '1px solid rgba(255,255,255,0.1)' }}
                >
                  <div className="flex gap-2 mb-4">
                    <div className="w-8 h-8 rounded bg-[#E07A5F]/20 flex items-center justify-center text-[#E07A5F]"><Target size={16} /></div>
                    <div>
                      <div className="text-sm font-bold">Suggested Angle</div>
                      <div className="text-xs text-gray-400">Based on recent hiring data</div>
                    </div>
                  </div>
                  <div className="h-16 rounded bg-black/40 border border-white/5 mb-4 p-3 text-sm text-gray-300">
                    "Noticed your team is scaling SDRs. Our platform enforces sequence discipline automatically..."
                  </div>
                  <button className="w-full py-2 rounded bg-[#E07A5F] text-black text-sm font-bold">
                    Apply to Email
                  </button>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="absolute bottom-10 right-10 w-48 rounded-xl p-4 backdrop-blur-md shadow-2xl"
                  style={{ background: 'rgba(40, 40, 40, 0.9)', border: '1px solid rgba(255,255,255,0.1)' }}
                >
                  <div className="text-xs text-gray-400 mb-2">Next Best Action</div>
                  <div className="flex items-center gap-2 text-sm font-medium">
                    <Phone size={14} color="#4A90E2" /> Follow up call
                  </div>
                </motion.div>
              </div>
            </RevealSection>
        ...
        <section className="py-32 w-full border-t" style={{ borderColor: 'rgba(255,255,255,0.05)', background: 'rgba(0,0,0,0.2)' }}>
          <div className="max-w-7xl mx-auto px-8">
            <RevealSection className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4">Built for teams that choose to execute.</h2>
            </RevealSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <RevealSection key={i}>
                  <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.01] h-full">
                    <div className="text-xs uppercase tracking-widest text-[#E07A5F] mb-4">{item.pre}</div>
        ...
        {/* --- Footer & CTA --- */}
        <section className="py-32 px-8 w-full border-t flex flex-col items-center text-center" style={{ borderColor: 'rgba(255,255,255,0.05)', background: '#0a0a0a' }}>
          <RevealSection className="max-w-3xl">
            <h2 className="text-5xl font-bold mb-8" style={{ fontFamily: 'var(--font-display)' }}>Eliminate switching fear.</h2>
            ...
            <button
              onClick={() => navigate(session ? '/dashboard' : '/login')}
              className="px-8 py-4 rounded-full text-base font-semibold transition-all hover:scale-105 inline-flex items-center gap-2"
              style={{ background: '#E07A5F', color: '#121212' }}
            >
              Book a Live Demo
              <ArrowRight size={18} />
            </button>
            <p className="mt-6 text-sm text-gray-500">No credit card required • Response within 2 hours</p>
          </RevealSection>
          
          <div className="w-full max-w-7xl mt-32 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-sm text-gray-500">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              <Logo /> <span className="ml-4">© 2026 AltLeads Inc.</span>
            </div>
...
fs.writeFileSync('/Users/hemalbadola/Downloads/AltLeads-CRM-main/new-code/web/src/pages/LandingPage.tsx', content);
